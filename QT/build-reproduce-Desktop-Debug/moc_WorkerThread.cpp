...
#include "../reproduce/WorkerThread.h"
...
QT_MOC_LITERAL(3, 30, 4) // "info"
    ...
    "WorkerThread\0progressChanged\0\0info"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->progressChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WorkerThread::*)(QString );
...
// SIGNAL 0
void WorkerThread::progressChanged(QString _t1)
{
